...
fprintf('Trying out different learning rates...\n');
...
test_case = [1650, 3];
test_case_norm = (test_case-mu)./sigma;
test_case_norm2 = [1, test_case_norm];
price = test_case_norm2*theta; % You should change this
